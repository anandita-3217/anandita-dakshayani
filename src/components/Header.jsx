...
const Header = () => {
  ...
  const shadowColor = colorMode === "dark"
    ...
    : "0 8px 32px rgba(0,0,0,0.1)";
  const activeLinkColor = useColorModeValue("fuchsia.800", "fuchsia.50");
  const cmdBg = useColorModeValue("fuchsia.500", "fuchsia.600");
  ...
  return (
    <>
      ...
      {/* Command Palette Button - Separate floating button */}
      <MotionBox
        position="fixed"
        top="16px"
        right={{ base: "5%", md: "calc((100% - 1152px) / 2 - 120px)" }} // Further to the right
        zIndex={51}
