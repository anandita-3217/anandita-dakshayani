...
//   Tabs, TabList, TabPanels, Tab, TabPanel, chakra,
...
//             <Text fontFamily={H} fontSize={{ base: '24px', md: '40px' }} fontWeight="900"
//               letterSpacing="-0.02em" lineHeight={1.05} color="white">
//               {'Credentials & '.split('').map((char, i) => (
//                 <motion.span key={i} style={{ display: 'inline-block' }}
//                   initial={{ opacity: 0, y: 36, rotateX: -90 }}
//                   animate={headerInView ? { opacity: 1, y: 0, rotateX: 0 } : { opacity: 0, y: 36, rotateX: -90 }}
//                   transition={{ duration: 0.42, delay: i * 0.022, ease: [0.23, 1, 0.32, 1] }}>
//                   {char === ' ' ? '\u00A0' : char}
//                 </motion.span>
//               ))}
//               <br />
//               <chakra.span bgGradient={GRAD} bgClip="text" display="inline-block">
//                 {'Achievements'.split('').map((char, i) => (
//                   <motion.span key={i} style={{ display: 'inline-block' }}
//                     initial={{ opacity: 0, y: 36, rotateX: -90 }}
//                     animate={headerInView ? { opacity: 1, y: 0, rotateX: 0 } : { opacity: 0, y: 36, rotateX: -90 }}
//                     transition={{ duration: 0.42, delay: (i + 14) * 0.022, ease: [0.23, 1, 0.32, 1] }}>
//                     {char}
//                   </motion.span>
//                 ))}
//               </chakra.span>
